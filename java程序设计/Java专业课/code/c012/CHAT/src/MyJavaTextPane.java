...
public class MyJavaTextPane extends JFrame {
	...
	private MyJTextJPane text = null; // 不用说了，如果不认识的话就没必要往后看了
	...
	private void insertIcon(File file) {
		...
		text.insertIcon(new ImageIcon(file.getPath()),file.getName()); // 插入图片
		 System.out.println("-----------"+text.getText());
		Enumeration e = text.getInputAttributes().copyAttributes()
				.getAttributeNames();
