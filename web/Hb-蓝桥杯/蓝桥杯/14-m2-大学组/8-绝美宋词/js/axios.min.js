								...
								r.forEach(i, function(n, i) {
									if (!r.isUndefined(n)) {
										...
										if (n && !s && "object" == typeof n)
											...
											else if (r.endsWith(i, "[]") && (a = r.toArray(
												n)))
											return void a.forEach(function(e) {
												!r.isUndefined(e) && t.append(u, o(
													e));
											});
										e(n, u);
									}
				...
				return new Promise(function(t, n) {
					...
					if (
						(E.open(
							...
							(E.onabort = function() {
								E &&
									(n(new l("Request aborted", l.ECONNABORTED, e, E)), (E =
										null));
							}),
							(E.onerror = function() {
								n(new l("Network Error", l.ERR_NETWORK, e, E, E)), (E =
									null);
							}),
							(E.ontimeout = function() {
								...
								e.timeoutErrorMessage && (t = e.timeoutErrorMessage),
									n(
										new l(
											t,
											r.clarifyTimeoutError ? l.ETIMEDOUT : l
											.ECONNABORTED,
											e,
											E
										)
					...
					"setRequestHeader" in E &&
						...
						((h = function(e) {
								E &&
									(n(!e || (e && e.type) ? new p() : e), E.abort(), (E =
										null));
							}),
