...
!(function(e, t) {
	...
	function Se(e, t) {
		if (!t) return e;
		for (
			var n, r, i, o = oe ? Reflect.ownKeys(t) : Object.keys(t), a = 0; a < o.length; a++
		)
			"__ob__" !== (n = o[a]) &&
			((r = e[n]),
				(i = t[n]),
	...
	function vt(e, t) {
		...
		if (Array.isArray(e) || "string" == typeof e)
			...
			if (oe && e[Symbol.iterator]) {
				...
				for (
					s = Object.keys(e), r = new Array(s.length), i = 0, a = s.length; i < a; i++
				)
					(c = s[i]), (r[i] = t(e[c], c, i));
			...
			prepatch: function(t, n) {
				...
				!(function(t, n, r, i, o) {
					...
					if (
						...
						$e(!1);
						for (
							var l = t._props, f = t.$options._propKeys || [], p = 0; p < f.length; p++
						) {
							var d = f[p],
								v = t.$options.props;
							l[d] = Me(d, v, n, t);
			...
			if ((o(i) && (i = f.extend(i)), "function" == typeof i)) {
				...
				if (r(i.options.functional))
					return (function(t, r, i, o, a) {
						...
						if (Array.isArray(p)) {
							for (
								var d = at(p) || [], v = new Array(d.length), h = 0; h < d.length; h++
							)
	...
	var ui,
		...
		vi = g(function(e) {
			if (
				...
				return e;
			for (
				var t = e.charAt(0).toUpperCase() + e.slice(1), n = 0; n < di.length; n++
			) {
				var r = di[n] + t;
				if (r in ui) return r;
			}
	...
	function hi(e, r) {
		...
		if (!(t(i.staticStyle) && t(i.style) && t(o.staticStyle) && t(o.style))) {
			...
			var d = (function(e, t) {
				...
				(n = si(e.data)) && A(r, n);
				for (var o = e;
					(o = o.parent);) o.data && (n = si(o.data)) && A(r, n);
				return r;
			})(r, !0);
	...
	var zi = (function(e) {
		...
		function b(e) {
			...
			if (n(i))
				for (
					n((t = i.hook)) && n((t = t.destroy)) && t(e), t = 0; t < s.destroy.length;
					++t
				)
					s.destroy[t](e);
			if (n((t = e.children)))
			...
			(function(e, t) {
				...
				function x() {
					...
					if (t) {
						...
						for (
							C(t[0].length); !(n = e.match(So)) && (r = e.match(xo) || e.match(Co));
				...
				function k(e) {
					...
					for (
						var u = a(n) || !!c, l = e.attrs.length, f = new Array(l), p = 0; p < l; p++
					) {
						var d = e.attrs[p],
							v = d[3] || d[4] || d[5] || "",
							h =
						...
						if (
							...
							(u = (function(e, t) {
								...
								if (n.test(e)) {
									...
									return (
										c < e.length &&
										(s.push((o = e.slice(c))), a.push(JSON.stringify(
											o))), {
											expression: a.join("+"),
											tokens: s
										}
