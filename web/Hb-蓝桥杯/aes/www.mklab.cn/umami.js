	...
	var t = function(t, e, n) {
		...
		e = function() {
			var t = window.doNotTrack,
				e = window.navigator,
				n = window.external,
				a = t || e.doNotTrack || e.msDoNotTrack || n && "function" == typeof n.msTrackingProtectionEnabled && n
	...
	! function(n) {
		...
		if (m) {
			var h, g = function(t) {
				...
				k = g("data-cache"),
				b = g("data-domains"),
				T = d.getItem("umami.disabled") || E && e() || b && !b.split(",").map((function(t) {
					return t.trim()
				})).includes(s),
				N = y ? (h = y) && h.length > 1 && h.endsWith("/") ? h.slice(0, -1) : h : m.src.split("/").slice(0, -1)
				.join("/"),
				j = i + "x" + r,
				q = [],
				I = "" + u + l,
					...
					if (!T) {
						...
						e && Object.keys(e).forEach((function(t) {
							...
							function(t, e, n) {
								...
								a.open("POST", t, !0), a.setRequestHeader("Content-Type", "application/json"), a
				...
				P = function(t, e, n) {
					return void 0 === t && (t = I), void 0 === e && (e = L), void 0 === n && (n = w), O("pageview", {
						url: t,
						referrer: e
					}, n)
				},
				x = function(t, e, n, a) {
					return void 0 === e && (e = "custom"), void 0 === n && (n = I), void 0 === a && (a = w), O(
					"event", {
						event_type: e,
						event_value: t,
						url: n
				...
				R = function(t, e, n) {
					if (n) {
						H(), L = I;
						var a = n.toString();
						(I = "http" === a.substring(0, 4) ? "/" + a.split("/").splice(3).join("/") : a) !== L && P(I,
							L), setTimeout(A, 300)
					}
				};
			if (!n.umami) {
			...
			S && !T && (p.pushState = t(p, "pushState", R), p.replaceState = t(p, "replaceState", R), P(I, L), A())
		}
	}(window)
}();
