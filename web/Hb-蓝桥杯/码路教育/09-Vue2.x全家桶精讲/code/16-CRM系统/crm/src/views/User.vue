<template>
	<div>
		...
		<el-row class="tool-bar">
			<el-col :span="6">
				<el-input class="tool-input" v-model.trim="name" placeholder="请输入你要搜索的用户名"></el-input>
			</el-col>
			<el-col :span="6">
		...
		<!-- 表格 start -->
		<!-- data是提供数据源的 -->
		<el-table :data="dataList" border :height="getHeight()" v-loading="isLoading" @select-all="handleSelect"
		...
		<el-row class="footer">
			<el-col :span="4" align="left">
				<el-button type="danger" size="small" :disabled="isBatchDel" @click="bandleBatchDel">
					批量删除
				</el-button>
			</el-col>
		...
		<!-- 添加用户弹框 start -->
		<UserAdd v-if="showAdd" @close="handleAddClose" @handleAddSuccess="handleAddSuccess"></UserAdd>

		<UserEdit @handleEditSuccess="handleEditSuccess" :currentUser="currentUser" v-if="showEdit"
			@close="handleEditClose"></UserEdit>
		<!-- 添加用户弹框 end -->
	</div>
</template>
